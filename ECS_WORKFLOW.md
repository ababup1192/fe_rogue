...
- [~] 1. hide-then-render 廃止: そもそもノードを積まない（判定: `addChild` 使用が Game/GameLifecycle 以外ゼロ）
  ...
  - ☐ P6-1d Chest 脱ノード ☐ P6-1e GroundItem 脱ノード（縁取り点滅の位相を要設計）☐ P6-1f fx store に text/色/位置を拡張し view ノード全廃 ☐ P6-1g WeaponIcon/HPBar ☐ P6-1h ユニット sprite（アニメ frame の World component 化＋advanceFrame System＋deathBlink 再レーン）
