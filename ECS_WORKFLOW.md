...
>
> ### 現在地（2026-06-30）
> S0✅ S1✅ S2.0-2.5✅(🎉S2 store) S3✅(statuses) S4.1✅(unitView twin) S4.4✅(PlayerData twin) +proj 正準キー refactor✅(コミット済) **S4.4b✅(EnemyData twin・additive・1063緑・コミット待ち)** S4.2⬜ S4.3⬜ S5⬜ S6⬜ S7⬜ S8⬜ S9(調査一部✅) S10⬜。
