...
>
> ### 現在地（2026-06-30）
> S0✅ S1✅ S2.0-2.5✅(🎉S2 store) S3✅(statuses) S4.1✅(unitView twin) S4.4✅(PlayerData twin) S4.4b✅(EnemyData twin) +proj refactor✅ run検証batch✅(twin parity 実証) **S4.3a🟡(fromBoardQuery flip 済・敵ターン run 検証待ち)** S4.2(低価値=skip) S4.3b⬜(他 unitView 消費者) S5⬜ **S6🟡(field flip 進行中: waited✅ bottleUsed✅ followUpUsed✅ / 残=alerted→attackTargetId)** S7⬜ S8⬜ S9(調査一部✅) S10⬜。1063緑。
