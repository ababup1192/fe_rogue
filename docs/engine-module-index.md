...
- **Color** — 3 チャンネル sRGB-linear カラー（Float64・0.0〜1.0）。`{ r = 1.0, g = 0.0, b = 1.0 }` と書ける。
...
- **ZBand** — 重なり順（zIndex）を用途ごとの範囲に区切る取り決めの source of truth（HUD の範囲・デバッグの範囲・範囲の幅と clamp）。範囲の地図は docs/z-bands.md。
