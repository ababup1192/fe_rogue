...
ROOT_CWD_TOOLS="sprite anim style jargon fallback ui-overflow view f32"
# ケースのフォルダから走らせる検査（リポ全体を見るので使い捨ての偽リポを組む）。
CASE_CWD_TOOLS="check-refs check-render-budget check-api-index check-api-released precommit"
